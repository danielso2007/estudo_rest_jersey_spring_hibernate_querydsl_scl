...
public class BooksResource {
	...
	@GET
	public List<Book> get() throws ServiceException {
	...
	@GET
	@Path("/title/{title}")
	public List<Book> getByNome(@PathParam("title") String title) throws ServiceException {
	...
	@POST
	public Response post(Book c) throws ServiceException {
		bookService.save(c);
		return Response.Ok("Book salvo com sucesso");
	}

	@PUT
	public Response put(Book c) throws ServiceException {
		bookService.save(c);
